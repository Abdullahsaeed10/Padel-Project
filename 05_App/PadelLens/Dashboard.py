...
from utils import (BLUE, RED, GRAY, get_theme, inject_theme_css, kpi,
                   ...
                   partner_win_rate, render_demo_badge, render_table,
...
with hero_col:
    ...
    wr_line = win_rate_display(w, n10) + " win rate" if n10 >= 10 else win_rate_display(w, n10)
...
with c1:
    ...
    st.caption(f"**{best['partner']}** is your strongest pairing "
               f"({best_wr}). **{worst['partner']}** is your weakest "
               f"({worst_wr}).")
